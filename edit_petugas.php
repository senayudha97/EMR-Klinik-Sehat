...
if (isset($_POST['update_data'])) {
        ...
        $sql_update1 = "UPDATE tb_petugas SET nama       ='$nama',
                                              username   ='$username',
                                              password   ='$password',
                                              jk         ='$jk',
                                              lahir      ='$lahir',
  ...
  <body id="page-top">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color:#35a82d" id="sideNav">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a href="login_admin.php?id=#tampilpetugas" class="btn btn-danger js-scroll-trigger" >Kembali</a>
          </li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container-fluid p-0">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="isidata">
        <div class="my-auto">
          <h2 class="mb-5">Data Lengkap  <span style="color:#35a82d" > Petugas </span></h2>
