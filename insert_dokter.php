    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color:#35a82d" id="sideNav">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a href="login_dokter.php" class="btn btn-danger js-scroll-trigger">Kembali</a>
          </li>
        </ul>
      </div>
    </nav>
        ...
        <form class="" action="" method="post">
          ...
          <table cellspacing="0" cellpadding="10">
            ...
            <tr>
              ...
              <td>
                <label for=""><?php echo $row['petugas']; ?></label>
              </td>
            </tr>
            <tr>
              <td>
            ...
            <tr>
              ...
              <td>
                ...
                <td>
                  ...
                  $result_user1  = mysqli_query($conn, "SELECT nama FROM tb_dokter WHERE username = '$user1'");
            ...
            <tr>
              <td colspan="3">
                <center>
                <input type="submit" name="insert_dokter" class="btn btn-success" value="Proses">
              </center>
              </td>
            </tr>
          </table><?php } ?></form>
